...
function StatCard({ title, subtitle, imageUrl, bgColor }: StatCardProps) {
  return (
    <div
      className={`group relative ${bgColor} w-full h-[200px] rounded-xl shadow-md text-center overflow-hidden transition-all duration-300 ease-in-out hover:shadow-lg`}
    >
  ...
  const stats = [
    {
      ...
      bgColor: "bg-[#FFF7ED]",
      imageUrl: "/attached_assets/girl-vector.png",
    },
    {
      title: "1000+",
      subtitle: "Mock Tests",
      bgColor: "bg-[#FDEDED]",
      imageUrl: "/attached_assets/test-vector.png",
    },
    {
      title: "500+",
      subtitle: "Video Lectures",
      bgColor: "bg-[#F0F9FF]",
      imageUrl: "/attached_assets/video-lecture.png",
    },
    {
      title: "10000+",
      subtitle: "Notes",
      bgColor: "bg-[#F0FDF4]",
      imageUrl: "/attached_assets/practice-test.png",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-[#333333] mb-4">
            ...
            <span className="text-[#F26B1D]">Learners</span>
          </h2>
